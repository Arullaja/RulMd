...
exports.smsg = (conn, m, hasParent) => {
     ...
     */
     m.reply = async (text, chatId, options) => {
        ...
        conn.reply(chatId ? chatId : m.chat, text, m, { contextInfo: { mentionedJid: conn.parseMention(text), externalAdReply: { title: 'Simple Bot Whatsapp', body: wm, sourceUrl: 'https://youtube.com/channel/UC40jTE0rB3mp3wXLL76V92w', thumbnail: data }}, options })
    }
